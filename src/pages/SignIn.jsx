    ...
    <div className="max-w-md mx-auto pt-24">
      <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-slate-100">
        ...
        <form onSubmit={handleEmailSignIn} className="space-y-4">
          ...
          <Button type="submit" className="w-full rounded-full h-12 bg-blue-600 hover:bg-blue-700 text-white font-semibold">
            Se connecter
          </Button>
        </form>
        ...
        <Button onClick={handleGoogleSignIn} className="w-full rounded-full h-12 bg-white border-2 border-slate-200 text-slate-700 hover:bg-slate-50 font-semibold flex items-center justify-center gap-2">
