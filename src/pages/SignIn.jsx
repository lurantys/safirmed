    ...
    <div className="max-w-md mx-auto pt-24">
      <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-slate-100">
        ...
        <form onSubmit={handleEmailSignIn} className="space-y-4">
          ...
          <Button type="submit" disabled={processing} className="w-full rounded-full h-12 bg-blue-600 hover:bg-blue-700 text-white font-semibold disabled:opacity-50 flex items-center justify-center gap-2">
            {processing ? <><Loader2 className="h-5 w-5 animate-spin" /> Connexion...</> : 'Se connecter'}
          </Button>
        </form>
