            ...
            <div className="max-w-4xl mx-auto px-6 pt-12">
                ...
                <div className="bg-white rounded-[2rem] p-5 sm:p-8 md:p-12 shadow-sm border border-slate-100 flex flex-col sm:flex-row gap-6 sm:gap-10 items-center sm:items-start relative overflow-hidden text-center sm:text-left">
                    ...
                    <div className="flex-1 w-full z-10 flex flex-col items-center sm:items-start">
                        ...
                        <div className="mt-10 flex flex-col lg:flex-row flex-wrap justify-center sm:justify-start gap-4 w-full">
                            <Button size="lg" className="rounded-full bg-slate-900 hover:bg-slate-800 text-white shadow-xl shadow-slate-200/50 gap-2 h-14 px-6 sm:px-8 text-base md:text-lg w-full lg:w-auto shrink-0">
                                <CalendarCheck className="h-5 w-5 shrink-0" /> Prendre Rendez-vous par téléphone
                            </Button>
                                ...
                                if (isMobile) {
                                    ...
                                    return (
                                        <Button
                                            ...
                                            className="rounded-full bg-[#25D366] hover:bg-[#20BE5C] text-white shadow-xl shadow-[#25D366]/30 gap-2 h-14 px-6 sm:px-8 text-base md:text-lg w-full lg:w-auto shrink-0"
                                        >
                                            <WhatsappIcon /> Prendre Rendez-vous par WhatsApp
                                        </Button>
                                    );
                                } else {
                                    return (
                                        <Button
                                            size="lg"
                                            disabled
                                            className="rounded-full bg-slate-200 text-slate-400 cursor-not-allowed gap-2 h-14 px-6 sm:px-8 text-base md:text-lg w-full lg:w-auto shrink-0"
                                        >
