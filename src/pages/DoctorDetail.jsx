                    ...
                    <div className="flex-1 w-full z-10 flex flex-col items-center sm:items-start">
                        ...
                        <div className="mt-8 sm:mt-10 flex flex-col lg:flex-row flex-wrap justify-center sm:justify-start gap-3 sm:gap-4 w-full">
                            <Button
                                ...
                                className="rounded-2xl sm:rounded-full bg-blue-600 hover:bg-blue-700 text-white shadow-xl shadow-slate-200/50 gap-2 h-auto min-h-[56px] py-3 sm:py-0 px-4 sm:px-8 text-sm sm:text-base md:text-lg w-full lg:w-auto overflow-hidden whitespace-normal"
                            >
                                <CalendarCheck className="h-5 w-5 shrink-0" /> Prendre RDV par téléphone
                            </Button>
